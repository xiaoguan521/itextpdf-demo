...
/**
 * Author xiaochen
 * Date 2022-02-18 - 9:15
 * Description TODO
 */
public class ReportTest5 {
...
//        try {
//            ReportTest5 app = new ReportTest5();
//            // 将证书文件放入指定路径，并读取keystore ，获得私钥和证书链
//            String pkPath = "F:\\Ddemo\\itext\\server.p12";
...
//            //需要进行签章的pdf
//            String path = "F:\\Ddemo\\itext\\demo3.pdf";
//            // 封装签章信息
...
//            signInfo.setFieldName("demo15");//重复签章时，需要修改此字段名
//            // 签章图片
//            signInfo.setImagePath("F:\\Ddemo\\itext\\sign2.png");
...
//            signInfo.setRecturx(700);  // 值越大   代表向x轴坐标向右平移  （大小不变）
//            signInfo.setRectury(100);  // 值越大，代表向y轴坐标向上平移（大小不变）
//            //签章后的pdf路径
//            app.sign(path, "F:\\Ddemo\\itext\\demo3.pdf", signInfo);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
